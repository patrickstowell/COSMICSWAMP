...
information_platform.neutron_probe.create(session, f"NeutronProbe:Dry2000", time_index=time_start.isoformat(), c0=0, nd0=2000, center_location=field_center)
information_platform.neutron_probe.create(session, f"NeutronProbe:Dry1500", time_index=time_start.isoformat(), c0=0, nd0=1500, center_location=field_center)
information_platform.neutron_probe.create(session, f"NeutronProbe:Dry1000", time_index=time_start.isoformat(), c0=0, nd0=1000, center_location=field_center)
...
for zone in information_platform.field.get_associated_zones(session, "Field:1"):
    ...
    plt.xlim( [np.min(df.day), np.max(df.day)])
    plt.show()
    ...
    cosmicswamp.delete_timeseries_for_entity(session, f"NeutronProbe:Dry2000", "NeutronProbe")
    cosmicswamp.delete_timeseries_for_entity(session, f"NeutronProbe:Dry1500", "NeutronProbe")
    cosmicswamp.delete_timeseries_for_entity(session, f"NeutronProbe:Dry1000", "NeutronProbe")
    ...
    while time_current < time_end:
        ...
        information_platform.neutron_probe.simulate(session, f"NeutronProbe:Dry2000", time_index=time_current.isoformat(), smc0=sm0, nd0=2000)
        information_platform.neutron_probe.simulate(session, f"NeutronProbe:Dry1500", time_index=time_current.isoformat(), smc0=sm0, nd0=1500)
        information_platform.neutron_probe.simulate(session, f"NeutronProbe:Dry1000", time_index=time_current.isoformat(), smc0=sm0, nd0=1000)
